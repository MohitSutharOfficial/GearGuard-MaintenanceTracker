      ...
      <div className="w-full max-w-md">
        ...
        <div className="odoo-card p-8">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-3.5 h-3.5 text-[#714B67] border-odoo-border rounded focus:ring-1 focus:ring-[#714B67]"
                />
                <span className="ml-2 text-odoo-gray-600">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
                className="text-[#714B67] hover:text-[#8B5E7F] font-medium"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-xs text-odoo-gray-600">
            ...
            <Link to="/signup" className="text-[#714B67] hover:text-[#8B5E7F] font-medium">
              Create one
            </Link>
          </p>
        </div>
