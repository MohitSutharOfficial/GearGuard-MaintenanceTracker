import { AlertCircle, Loader2, Lock, Mail, Wrench } from 'lucide-react';
    ...
    <div className="min-h-screen bg-odoo-light flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-14 h-14 bg-odoo-primary rounded mb-3">
            <Wrench className="w-7 h-7 text-white" />
          </div>
          <h1 className="text-2xl font-semibold text-odoo-gray-900">GearGuard</h1>
          <p className="text-sm text-odoo-gray-600 mt-1">Maintenance Management System</p>
        </div>

        {/* Login Card */}
        <div className="odoo-card p-8">
          <h2 className="text-xl font-semibold text-odoo-gray-900 mb-6 text-center">Sign in to your account</h2>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer">
                <input
                  type="checkbox"
                  className="w-3.5 h-3.5 text-odoo-primary border-odoo-border rounded focus:ring-1 focus:ring-odoo-primary"
                />
                <span className="ml-2 text-odoo-gray-600">Remember me</span>
              </label>
              <Link
                to="/forgot-password"
                className="text-odoo-primary hover:text-odoo-secondary font-medium"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-xs text-odoo-gray-600">
            ...
            <Link to="/signup" className="text-odoo-primary hover:text-odoo-secondary font-medium">
              Create one
            </Link>
          </p>
        </div>
